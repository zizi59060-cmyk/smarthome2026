...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("launch_vision_adapter", default_value="true"),
        ...
        DeclareLaunchArgument("serial_reconnect_interval", default_value="1.0"),
        DeclareLaunchArgument("cmd_vel_topic", default_value="/cmd_vel"),
        DeclareLaunchArgument("vision_detected_topic", default_value="/detected_target"),
        DeclareLaunchArgument("vision_target_topic", default_value="/smarthome/object_target"),
        DeclareLaunchArgument("vision_frame_id", default_value="camera_link"),
        ...
        # The vision node keeps detection and pose solving only. Its gimbal serial
        # is disabled by vision_override.yaml, then this adapter publishes the
        # common ObjectTarget topic consumed by smarthome_comm.
        Node(
        ...
        Node(
            ...
            executable="vision_detected_target_adapter",
            name="vision_detected_target_adapter",
            output="screen",
            parameters=[{
                "input_topic": LaunchConfiguration("vision_detected_topic"),
                "output_target_topic": LaunchConfiguration("vision_target_topic"),
                "frame_id": LaunchConfiguration("vision_frame_id"),
                "publish_untracked": False,
            }],
            condition=IfCondition(LaunchConfiguration("launch_vision_adapter")),
        ),
        ...
        IncludeLaunchDescription(
            ...
            launch_arguments={
                ...
                "serial_reconnect_interval": LaunchConfiguration("serial_reconnect_interval"),
            }.items(),
        ),
